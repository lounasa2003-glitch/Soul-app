...
function valoresSecretos() {
  return [
    ...
    // Mercado Pago (lib/mercadoPago.js, api/webhooks/mercadopago.js) -- el
    // access token de la API y el secreto de firma del webhook son igual de
    // sensibles que el resto de arriba.
