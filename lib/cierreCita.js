...
export async function finalizarCita(supabaseUrl, headers, citaId, cita, match, mensajeCierre) {
  ...
  await Promise.all([
    ...
    enviarPushAUsuario(match.usuario_a, { titulo: 'Tu encuentro cerró', cuerpo: 'Soul preparó una reflexión para vos.', data: { tipo: 'debriefing_listo', citaId } }),
    enviarPushAUsuario(match.usuario_b, { titulo: 'Tu encuentro cerró', cuerpo: 'Soul preparó una reflexión para vos.', data: { tipo: 'debriefing_listo', citaId } })
  ]).catch(() => {});
}
