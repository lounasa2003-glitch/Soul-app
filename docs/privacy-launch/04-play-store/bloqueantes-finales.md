...
4. **Verificación de edad no se re-aplica al editar el perfil.** `soul.html:3268-3299` permite cambiar `fecha_nacimiento` desde "Mi perfil" sin pasar por el chequeo de `EDAD_MINIMA` de `api/guardar.js`. — *Acción: aplicar el mismo chequeo a esa ruta.* (`contradicciones.md` C-03)
